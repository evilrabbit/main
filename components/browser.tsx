...
export function Browser({ url, showContent = false, children }: BrowserProps) {
  return (
    <div className="rounded-xl overflow-hidden" style={{ backgroundColor: "#2a2a2a", maxWidth: "650px" }}>
      {/* Browser header */}
      <div className="flex items-center px-4 py-3 gap-4">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="flex items-center gap-2 bg-[#1a1a1a] rounded-md px-4 py-1.5 min-w-[280px]">
            <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-[#666]">
            ...
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-[#666] ml-auto">
              <path d="M1.75 7C1.75 7 3.5 3.5 7 3.5C10.5 3.5 12.25 7 12.25 7C12.25 7 10.5 10.5 7 10.5C3.5 10.5 1.75 7 1.75 7Z" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M12.25 1.75L1.75 12.25" stroke="currentColor" strokeLinecap="round"/>
            </svg>
          </div>
        </div>
