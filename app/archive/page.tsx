        ...
        <div className="max-w-[700px] w-full mx-auto px-4 flex-grow">
            ...
            <div className="flex flex-col items-start">
              <Link href="/">
                <svg
                  ...
                  className="w-[2.88rem] h-[2.88rem] hover:opacity-70 transition-opacity"
                  aria-hidden="true"
                >
          ...
          <section className="mb-12 fade-in delay-6">
            ...
            <ul className="space-y-2 mb-12">
              <li>
                <Link href="https://heyato.ai" className="hover:text-gray-300">
                  Ato
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="https://www.pumabrowser.com/" className="hover:text-gray-300">
                  Puma Browser
                </Link>
              </li>
            </ul>
